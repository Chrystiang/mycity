modernUI.showUpdateLog = function(self, badge)
	...
	local version = 'v'..table.concat(version, '.')
	local width = 520
	local height = 300
	...
	ui.addTextArea(id..'891', '<font size="10">'..version, player, 610, 63, nil, nil, 0, 0, 0, true)
	ui.addTextArea(id..'892', '<p align="center"><font color="#caed87" size="15"><b>'..translate('$VersionName', player), player, 0, 63, 800, nil, 0, 0, 0, true)
