lang.fr = {
	...
	maxPlacedFurnitures = "Vous ne pouvez qu'avoir %s meubles dans votre maison.",
	...
	badgeDesc_11 = 'Top 10 de la saison 1',
	caught_goldenmare = '<v>%s</v> <j>a pêché un Goldenmare!</j>',
	newCar = 'Nouvelle Voiture',
	unlockedCar = 'Félicitations! Vous avez déverrouillé une nouvelle voiture!',
	seasonReward = 'Récompense de Saison',
	furniture_inflatableDuck = 'Canard Gonflable',
	furniture_lifesaverChair = 'Chaise de Sauveteur',
	furniture_coolBox = 'Glacière',
	furniture_bbqGrill = 'Barbecue',
	furniture_shower = 'Douche',
	furniture_flamingo = 'Flamant',
	...
	-- V3.2.0
	trade_title = 'Échange',
	confirmButton_trade = 'Échanger',
	confirmButton_cancel = 'Fermer',
	trade_cancelled = '%s a annulé l\'échange.',
	trade_cancelled_title = 'Trade cancelled',
	trade_invite = '%s veut lancer un échange avec vous.',
	trade_invitePlayer = 'Proposer un échange',
	trade_wishList = 'Liste de Souhaits',
	trade_playerAlreadyTrading = '%s est déjà en échange avec quelqu\'un d\'autres.',
	trade_success = 'Échange réussi!',
	item_meat = 'Viande',
	item_mushroom = 'Champignon',
	item_cheeseburger = 'Cheeseburger',
	item_lasagna = 'Lasagne',
	item_meatballs = 'Boulettes de Viande',
	item_garlicMashedPotatoes = 'Purée de Patates à l\'Ail',
	item_mushroomBurger = 'Burger aux Champignons',
	item_creamOfMushroom = 'Crème de Champignons',
	item_pumpkinPie = 'Tarte à la Citrouille',
	item_steakFrites = 'Steak Frites',
	item_breadedCutlet = 'Escalope Panée',
	item_fishAndChips = 'Poisson Frites',
	npcDialog_Lindsey = 'Voulez-vous vendre un fruit?\nDéposez-le à côté de moi pour que je puisse estimer son prix.',
	tradeSystem_title = 'Système d\'échange',
	trade_invite_title = 'Requête d\'Échange', 
	settings_config_disableTrades = 'Désactiver les requêtes échanges',
	trade_invite_error = '%s n\'accepte pas les requêtes d\'échanges.',
	txt_openProfile = 'Ouvrir le profil',
	profile_fruitsSold = 'Vente de fruits',
	profile_crystalsSold = 'Cristaux Vendus:<li>',
	profile_crystal_yellow = '<j>Jaune',
	profile_crystal_blue = '<bv>Bleu',
	...
	--- V3.3.0
	trade_error_quest = 'Les échanges sont disponibles après avoir terminé %s.',
	trade_error_quest2 = '%s doit finir %s afin d\'accepter les échanges.',
	furniture_toilet = 'Toilette',
	profile_changeOrb = 'Changer l\'Orbe de Niveau',
	House10 = 'Maison Citrouille',
	houseDescription_10 = 'Provenant d\'un dosage élevé de super engrais, cette maison de citrouille offre le confort parfait pour les nuits les plus effrayantes.',
	furniture_dryTree = 'Arbre Sec',
	confirmButton_Play = 'Jouer!',
	newLevelOrb = 'Orbe de Nouveau Niveau',
	newLevelOrb_info = 'Vous pouvez changer votre orbe de niveau en ouvrant votre profil.',
	item_strangePumpkin = 'Seau de Citrouille',
	item_strangePumpkinSeed = 'Graine de Citrouille Étrange',
	item_candyBucket = 'Seau de Bonbons',
	airVehicles = 'Air',
	vehicle_16 = 'Ballon',
	vehicle_17 = 'Balai',
	furniture_lamp = 'Lampe',
	furniture_amongUs_vent = 'Among Us: Ventilation',
	furniture_amongUs_medBay = 'Among Us: Infirmerie',
	tip_airVehicle = 'Appuyez sur ESPACE pour arrêter d\'utiliser un véhicule volant.',
	furniture_bloodstain = 'Tache de Sang',
	--- V3.3.2
	trade_playerLeftRoom = '%s a quitté le salon.',
	trade_playerUsingAnItem = '%s est actuellement en train d\'utiliser un objet .',
	trade_unknownItems = 'Objet inconnu',
	-- V3.4.0
    item_fish_Mudfish = 'Poisson de Boue',
    item_fish_Frozice = 'Poisson des Glaces',
    item_fish_Sinkfish = 'Poisson d\'Évier',
    item_fish_Bittyfish = 'Tout Petit Poisson',
    item_raspberry = 'Framboise',
    item_raspberrySeed = 'Graine de Framboise',
    furniture_liveFence = 'Barrière de Buisson',
    furniture_mailbox = 'Boite aux lettres',
    furniture_chimney = 'Cheminée',
    furniture_lights = 'Lumières',
    furniture_candies = 'Sucreries',
    furniture_trunk = 'Tronc',
    furniture_christmasTree = 'Arbre de Noël',
    item_redPresent = 'Cadeau Rouge',
    itemDesc_redPresent = 'Une simple boître qui contient un cadeau aléatoire.',
    npcDialog_Elf = 'Bienvenue à l\'Atelier de la Tour de l\'Horloge!\nIci tu pouras rencontrer Jingle, vendre des cadeaux et acheter de rares meubles...\nSi tu veux vendre des cadeaux, dépose-les juste à côté de moi et je m\'en occuperai!\nLes cadeaux peuvent être trouvés à n\'importe quel endroit de la ville. Une fois que vous en ouvrez un, il vous donnera une récompense aléatoire.\nApporte-moi 20 d\'entre eux et je te donnerai une récompense!\nBonne chance!\nN\'oublie pas que cet événement se terminera dans %s jours et que les cadeaux disparaîtront une fois que 3 joueurs les auront récupérés.',
    npcDialog_Skipper = 'Bonjour!\n...\nTu ne ressembles pas à l\'un d\'entre nous, tu n\'es donc pas autorisé(e) à entrer dans ce village.\n...\nEnfin, si tu veux te joindre à nous, tu devras me rendre un service.\nI need you to bring to me 5 Frozices. It is a species of rare fish that can only be attracted by rare fruits.\nOnce you get them, bring it to me and I will allow you to join this village.',
    House11 = 'Iglou',
