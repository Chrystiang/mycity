lang.tr = {
	...
	item_fish_Guppy = "Minik Lepistes",
	landVehicles = "Kara",
	...
	maxPlacedFurnitures = "Evinde sadece %s adet mobilyaya sahip olabilirsin.",
	...
	--- V3.3.0
	trade_error_quest = 'Takaslar  %s. görevi tamamladıktan sonra aktif olur.', -- Will print: "Takaslar Görev 01: Tekne Yapmak! tamamladıktan sonra aktif olur."
    trade_error_quest2 = '%s takas kabul edebilmesi için %s i tamamlaması gerekiyor.',
    furniture_toilet = 'Tuvalet',
    profile_changeOrb = 'Seviye Küresini Değiştir',
    House10 = 'Balkabağı Evi',
    houseDescription_10 = 'Yüksek dozda süper gübreden kaynaklı, bu balkabağı evi en korkunç evler için mükemmel konforu sunuyor.',
    furniture_dryTree = 'Kuru Ağaç',
    confirmButton_Play = 'Oyna!',
    newLevelOrb = 'Yeni Seviye Küresi',
    newLevelOrb_info = 'Profilini açarak seviye küreni değiştirebilirsin.',
    item_strangePumpkin = 'Balkabağı Kovası',
    item_strangePumpkinSeed = 'Garip Balkabağı Tohumu',
    item_candyBucket = 'Şeker Kovası',
    airVehicles = 'Hava',
    vehicle_16 = 'Balon',
    vehicle_17 = 'Süpürge',
    furniture_lamp = 'Lamba',
    furniture_amongUs_vent = 'Among Us: Havalandırma',
	...
	--- V3.4.0
	item_fish_Mudfish = 'Kel Balık',
    item_fish_Frozice = 'Buzbalık',
    item_fish_Sinkfish = 'Akarsu Balığı',
    item_fish_Bittyfish = 'BalBalık',
    item_raspberry = 'Ahududu',
    item_raspberrySeed = 'Ahududu Tohumu',
    furniture_liveFence = 'Çit Bitkisi',
    furniture_mailbox = 'Posta Kutusu',
    furniture_chimney = 'Baca',
    furniture_lights = 'Işıklar',
    furniture_candies = 'Mumlar',
	furniture_trunk = 'Kütük',
    furniture_christmasTree = 'Noel Ağacı',
    item_redPresent = 'Kırmızı hediye',
    itemDesc_redPresent = 'Rastgele hediye içeren tamamen sıradan bir kutu.',
    npcDialog_Elf = 'Saat kulesi fabrikasına hoş geldin!\nBurada Jingle ile tanışabilir, hediye satabilir ve nadir mobilyalar satın alabilirsin...\nHediye satmak istiyorsan yanıma bırak merak etme ona çok iyi bakacağım!\nHediyeler haritanın herhangi bir yerinde bulunabilir. Birini açtığında, sana rastgele bir eşya gelecek.\nBana 20 hediye getirirsen sana ödülünü vereceğim!\nBol şans!\nUnutma ki bu etkinlik %s gün içinde sona eriyor ve hediyeler onları 3 oyuncu topladığı zaman kayboluyor.',
    npcDialog_Skipper = 'Selam!\n...\nPek bizim gibi görünmüyorsun o yüzden bu köye girmene iznin yok.\n...\nİllaki girmek istiyorsan, bana bir iyilik yap.\nBana 5 adet buzbalık getir. Bu tür balıklar çok nadirdir ve ilgilerini çekmek için nadir meyveler kullanmalısın.\nYakaladığın anda bana getirirsen bu köye girmene izin vereceğim.',
    House11 = 'İglo',
    houseDescription_11 = 'Köy penguenleri tarafından yapılmış el emeği göz nuru otantik bir ev.',
