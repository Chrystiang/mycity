lang.pl = {
    ...
    --- V3.2.0
    trade_title = 'Handel',
    confirmButton_trade = 'Handel',
    confirmButton_cancel = 'Anuluj',
    trade_cancelled = '%s anulowal transakcje.',
    trade_cancelled_title = 'Transakcja anulowana',
    trade_invite = '%s chce rozpoczac handel.',
    trade_invitePlayer = 'Zaproponuj wymiane',
    trade_wishList = 'Lista zyczen',
    trade_playerAlreadyTrading = '%s handluje z kims innym.',
    trade_success = 'Handel udany!',
    item_meat = 'Mieso',
    item_mushroom = 'Grzyb',
    item_cheeseburger = 'Cheeseburger',
    item_lasagna = 'Lassania',
    item_meatballs = 'Klopsiki',
    item_garlicMashedPotatoes = 'Puree z czosnkiem',
    item_mushroomBurger = 'Grzybowy burger',
    item_creamOfMushroom = 'Krem grzybowy',
    item_pumpkinPie = 'Ciasto dyniowe',
    item_steakFrites = 'Smazony stek',
    item_breadedCutlet = 'Kotlet Panierowany',
    item_fishAndChips = 'Ryba z frytkami',
    npcDialog_Lindsey = 'Czy chcesz sprzedac owoc?\nUpusc go obok mnie, abym mogl oszacowac jego cene.',
    tradeSystem_title = 'System Handlu',
    trade_invite_title = 'Zapytaj o handel',
    settings_config_disableTrades = 'Wylacz mozliwosc handlu',
    trade_invite_error = '%s nie akceptuje zlecen handlowych.',
    txt_openProfile = 'Otworz profil',
    profile_fruitsSold = 'Sprzedane owoce',
    profile_crystalsSold = 'Sprzedane krysztaly: <li>',
    profile_crystal_yellow = '<j>Zolty',
    profile_crystal_blue = '<bv>Niebieski',
    ...
    --- V3.3.0
    trade_error_quest = 'Transakcje sa dostępne po ukonczeniu %s.',
    trade_error_quest2 = '%s musi zakonczyc %s, aby akceptowac transakcje.',
    Furniture_toilet = 'Toaleta',
    profile_changeOrb = 'Zmien kule poziomu',
    House10 = 'Pumpkin House',
    houseDescription_10 = 'Pochodzacy z dużej dawki super nawozow, ten domek z dyni oferuje doskonały komfort w najbardziej przerazajace noce.',
    Furniture_dryTree = 'Suche drzewo',
    confirmButton_Play = 'Graj!',
    newLevelOrb = 'Nowa kula poziomu',
    newLevelOrb_info = 'Mozesz zmienic swoja kule poziomu otwierajac swoj profil.',
    item_strangePumpkin = 'Dziwna dynia',
    item_strangePumpkinSeed = 'Dziwne pestki dyni',
    item_candyBucket = 'Wiadro z cukierkami',
    airVehicles = 'Powietrze',
    vehicle_16 = 'Balon',
    vehicle_17 = 'Miotla',
    Furniture_lamp = 'Lampa',
    Furniture_amongUs_vent = 'Among Us: Vent',
    Furniture_amongUs_medBay = 'Among Us: Med Bay',
    tip_airVehicle = 'Naciśnij SPACJE, aby przestac uzywac latajacego pojazdu.',
    Furniture_bloodstain = 'Plama krwi',
}