lang.pl = {
    ...
    maxPlacedFurnitures = "Mozesz tylko posiadac %s mebli w swoim domu.",
    ...
    --- V3.4.0
    item_fish_Mudfish = 'Ryba blotna',
    item_fish_Frozice = 'Frozice',
    item_fish_Sinkfish = 'Sink Fish',
    item_fish_Bittyfish = 'Bitty Fish',
    item_raspberry = 'Malina',
    item_raspberrySeed = 'Nasiona maliny',
    furniture_liveFence = 'Zywoplot',
    furniture_mailbox = 'Skrzynka pocztowa',
    furniture_chimney = 'Komin',
    furniture_lights = 'Swiatelka',
    furniture_candies = 'Cukierki',
    furniture_trunk = 'Kłoda drzewa',
    furniture_christmasTree = 'Choinka',
    item_redPresent = 'Czerwony prezen',
    itemDesc_redPresent = 'Proste pudelko zawierajace losowy prezent.',
    npcDialog_Elf = 'Witamy w Warsztacie Wiezy Zegarowej! \nTutaj mozesz spotkac Jingle, sprzedawac prezenty i kupowac rzadkie meble ... \nJesli chcesz sprzedawac prezenty, po prostu upusc je obok mnie, a ja sie nimi zajme! \nPrezenty mozna znalezc w dowolnym miejscu na mapie. Po otwarciu jednego z nich otrzymasz losowy przedmiot. \nPrzynies mi 20 sztuk, a ja dam ci nagrode! \nPowodzenia! \nPamietaj, ze to wydarzenie zakonczy się za %s dni, a prezenty znikna, gdy 3 graczy je zdobedzie.',
    npcDialog_Skipper = 'Czesc! \n ... \nNie wygladasz jak jeden z nas, wiec nie mozesz wejsc do tej wioski. \n ... \nCoz, jesli chcesz dolaczyc, musisz zrobic mi przysluge. \nPrzyniesc mi 5 Zamrozonych. Jest to gatunek rzadkich ryb, ktore przyciagaja tylko rzadkie owoce. \nGdy je zdobedziesz, przynies mi je, a pozwole ci dolaczyc do tej wioski. ',
    house11 = 'Igloo',
    houseDescription_11 = 'Autentyczne igloo wykonane recznie przez pingwiny z wioski.',
