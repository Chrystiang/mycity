lang.en = {
	...
	remove = 'Remove',
	items = 'Items:',
	bagError = 'Insufficient space in your bagpack.',
	...
	goldAdded = 'The gold nugget has been added to your bag.',
	...
	warning = 'Warning',
	bagTemporaryLimit = 'You are carrying an amount of items that are higher than your current bag limit. Remember that only %s items are are guaranteed to be saved after you leave the room.',
	-- V3.4.0
