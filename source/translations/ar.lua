lang.ar = {
	...
	item_potato = "بطاطا",
	maxPlacedFurnitures = ".أثاث في منزلك %s يمكنك فقط الحصول على",
	...
	item_fish_Smolty = "سمكة سلمون صغيرة",
	...
	--- V3.2.0
	trade_title = 'التبادل',
	confirmButton_trade = 'تبادل', 
	confirmButton_cancel = 'إلغاء',
	trade_cancelled = '.عملية التبادل %s لقد ألغى',
	trade_cancelled_title = 'تم إلغاء عملية التبادل',
	trade_invite = '.يريد بدء عملية التبادل %s',
	trade_invitePlayer = 'إقتراح التبادل',
	trade_wishList = 'قائمة الرغبات',
	trade_playerAlreadyTrading = '.يقوم بالمبادلة مع شخص آخر %s',
	trade_success = '!لقد تمت المبادلة بنجاح',
	item_meat = 'لحمة',
	item_mushroom = 'فطر',
	item_cheeseburger = 'تشيز برغر',
	item_lasagna = 'لازانيا',
	item_meatballs = 'كرات اللحم',
	item_garlicMashedPotatoes = 'بطاطا مهروسة بالثوم',
	item_mushroomBurger = 'شطيرة بالفطر',
	item_creamOfMushroom = 'كريم الفطر',
	item_pumpkinPie = 'فطيرة اليقطين',
	item_steakFrites = 'شريحة لحم و بطاطا',
	item_breadedCutlet = 'الكستليتة المخبوزة',
	item_fishAndChips = 'سمك و بطاطا',
	npcDialog_Lindsey = 'هل تريد بيع فاكهة؟\n.قم بإسقاطها بجانبي حتى أتمكن من تقدير سعرها',
	tradeSystem_title = 'نظام المبادلة',
	trade_invite_title = 'طلب التبادل',
	settings_config_disableTrades = 'تعطيل طلبات التبادل',
	trade_invite_error = '.لا يقبل طلبات التبادل %s',
	txt_openProfile = 'فتح الملف الشخصي',
	profile_fruitsSold = 'الفواكه المباعة',
	profile_crystalsSold = ': الكريستالات المُباعة<li>',
	profile_crystal_yellow = '<j>صفراء',
	profile_crystal_blue = '<bv>زرقاء',
	...
	--- V3.4.0
    item_fish_Mudfish = 'سمكة الآميا الملساء',
    item_fish_Frozice = 'سمكة متجمدة',
    item_fish_Sinkfish = 'سمكة زينة',
    item_fish_Bittyfish = 'سمكة البيتي',
    item_raspberry = 'توت العليق',
    item_raspberrySeed = 'بذرة توت العليق',
    furniture_liveFence = 'سور طبيعي',
    furniture_mailbox = 'صندوق بريد',
    furniture_chimney = 'مدفأة',
    furniture_lights = 'أضواء',
    furniture_candies = 'حلويات',
    furniture_trunk = 'جذع',
    furniture_christmasTree = 'شجرة عيد الميلاد',
    item_redPresent = 'هدية حمراء',
    itemDesc_redPresent = '.علبة بسيطة تحتوي على هدية عشوائية',
    npcDialog_Elf = '!مرحبًا بكم في ورشة برج الساعة\n ... هنا يمكنك مقابلة جينغل وبيع الهدايا وشراء الأثاث النادر\n!إذا كنت ترغب في بيع الهدايا ، فما عليك سوى إسقاطها بجانبي وسأعتني بها\n.يمكن العثور على الهدايا في أي مكان على الخريطة. بمجرد فتح واحدة ، ستعطيك غرضًا عشوائيًا\n!أحضر لي 20 منهم وسأكافئك\n!بالتوفيق\n.يوم وستختفي الهدايا بعد أن يجمعها 3 لاعبين %s تذكر أن هذا الحدث سينتهي في غضون',
    npcDialog_Skipper = '!مرحبًا\n...\n.أنت لا تبدو وكأنك واحد منا، لذلك لا يسمح لك بدخول هذه القرية\n...\n.حسنًا ، إذا كنت ترغب في الانضمام ، يجب أن تقدم لي معروفًا\nأريدك أن تحضر لي 5 فروزيس. إنه نوع من الأسماك النادرة التي لا يمكن أن تجذبها إلا الفواكه النادرة.\nبمجرد أن تحصل عليها ، أحضرها إلي وسأسمح لك بالدخول إلى هذه القرية.',
    House11 = 'كوخ الإسكيمو',
    houseDescription_11 = '.كوخ الإسكيمو الأصلي المصنوع يدويًا بواسطة طيور البطريق القروية',
    npcDialog_Perry = '.للأسف، لوحة الصدارة تحت الصيانة\n.وينبغي أن تنتهي في يناير، مع ميكانيكية جديدة لجعلها عادلة للاعبين الجدد',
    item_speedPotion = 'جرعة السرعة',
    itemDesc_speedPotion = ' استعمل هذه الجرعة لكي تمشي أسرع لـ%s ثانية',
}