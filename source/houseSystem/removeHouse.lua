HouseSystem.removeHouse = function(self)
	...
	if ownerData.houseData.houseid > 0 then
		...
		room.houseImgs[terrainID].img[#room.houseImgs[terrainID].img+1] = addImage(forSaleSign, "?" .. terrainID + 100, mainAssets.__terrainsPositions[terrainID][1], mainAssets.__terrainsPositions[terrainID][2])
