HouseSystem.expansions = {
	...
	[2] = {
		...
		add = function(owner, y, terrainID, plotID, guest)
			...
			room.houseImgs[terrainID].expansions[#room.houseImgs[terrainID].expansions+1] = addImage(stage, '!200000', (terrainID-1)*1500+738-(175/2) + (plotID-1)*175, y+170-45-275, guest)
