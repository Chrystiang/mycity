loadRanking = function(player)
	...
	for i = minn, maxx do
		...
		playerExperience[2][#playerExperience[2]+1] = '<p align="right"><font size="10"><vp>'.. gifts
		playerExperience[1][#playerExperience[1]+1] = '<p align="right"><font size="10" color="#2F692F">'.. gifts
