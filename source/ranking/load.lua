loadRanking = function(player)
	...
	if player then
		...
		ui.addTextArea(5442, '<p align="center"><font size="14"><r>'..translate('daysLeft', player):format(formatDaysRemaining(os.time{day=8, year=2020, month=10})), player, 93+ xAlign, 84+ yAlign, 400, nil, 0x324650, 0x0, 0)
	end
end